...
export const Selections = () => {
  return (
    <div className="flex flex-col gap-7 items-start justify-center w-full pb-6 tablet-sm:max-w-[640px] laptop:p-0 laptop:gap-9 desktop-md:max-w-[516px] desktop-4k:gap-16">
